...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="${pageContext.request.contextPath}/login/dashboard.html" class="logo">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="${pageContext.request.contextPath}/home/profile.html" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-right">
                  <a href="${pageContext.request.contextPath}/login/signout.html" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
